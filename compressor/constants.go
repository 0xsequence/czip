...
const (
	FLAG_READ_POW_10_MANTISSA_S uint = iota
	FLAG_READ_WORD_1
	FLAG_READ_WORD_2
	FLAG_READ_WORD_3
	FLAG_READ_WORD_4
...
func FlagNames() map[string]uint {
	...
	for i := uint(0); i <= LITERAL_ZERO; i++ {
		switch i {
		case FLAG_READ_POW_10_MANTISSA_S:
			names["FLAG_READ_POW_10_MANTISSA_S"] = i
		...
		case FLAG_POW_10:
			names["FLAG_POW_10"] = i
		case FLAG_SELF_EXECUTE:
			names["FLAG_SELF_EXECUTE"] = i
		...
		case FLAG_BYTES32_INV_PADDING:
			names["FLAG_BYTES32_INV_PADDING"] = i
...
const LITERAL_ZERO = FLAG_READ_STORE_FLAG_L + 1
